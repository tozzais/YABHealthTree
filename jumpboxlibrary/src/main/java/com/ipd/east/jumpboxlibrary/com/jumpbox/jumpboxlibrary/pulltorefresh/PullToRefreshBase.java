package com.ipd.east.jumpboxlibrary.com.jumpbox.jumpboxlibrary.pulltorefresh;

import com.ipd.east.jumpboxlibrary.com.jumpbox.jumpboxlibrary.pulltorefresh.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public PullToRefreshBase(Context context, boolean autoRefresh) {
		super(context);
		init(context, null);
	}
	...
	public void firstRefresh() {
		smoothScrollTo(-mHeaderHeight - 30, 400, 0);
		// 调用刷新
